...
console.log(crd);
    ...
    crd.forEach(function(curValue){
         curValue.addEventListener("click", function(){
            ...
            buyBtn.addEventListener("click", function(e){
               ...
               if(name.value == "" && address.value == "" && num.value == "" && optionselect.value){
                alert("Please Enter Detail")
               }else{
                alert("Your Response Recorded");
                document.querySelector(".buyPage").style.display="none";
                console.log(name.value,address.value,num.value,optionselect.value);
    ...
    function connect(){
        ...
        if(names.value == "" && num.value == ""){
            ...
            console.log(names.value, num.value)
        }
